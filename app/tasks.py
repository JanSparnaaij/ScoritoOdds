...
def fetch_tennis_matches_in_background(league: str) -> None:
    ...
    try:
        ...
        # Retrieve URLs for the tennis league
        ...
        # Fetch, process, and cache matches
...
def fetch_matches_in_background(league: str) -> None:
    """
    ...
    """
    try:
        log_task_status(logger, "start", task_name="fetch_matches_in_background", league=league)

        # Retrieve URL for the football league
        ...
        logger.error(f"Error in fetch_matches_in_background for league {league}: {e}")
